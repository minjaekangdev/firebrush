...
function Landing() {
  return (
    <div>
      <div className="landing-bg text-center landing-main">
        ...
        <div className="mx-auto">
          <div className="twothird p-5 float-start">
            ...
            <p className="text-muted">
              We here at firebrush strive to assist all keyboard-related events
              around the world by providing a platform that anyone can use by
              simplifying all aspects of event management.
            </p>
          </div>
      ...
      <div className="bg-light landing-container">
        <div className="mx-auto">
          <div className="third text-center float-start">
            <img src={howto} alt="howto" className="aboutus-keyboard mt-5" />
          </div>
          ...
          <div className="twothird px-5 my-4 float-start">
            ...
            <p className="text-muted">
              ...
              From here you can choose to either create a new event, or join any
              of the events that are on the page.
              <br />
              Once you have joined your events, you can view them by clicking
              your avatar image in the top right and selecting "My Events".{" "}
              <br />
              For more information, please contact us at minjaekangdev@gmail.com
            </p>
          </div>
        </div>
      </div>
